...
/**
 * Represents the English-version instance of the Marble Solitaire game with monitoring and
 * manipulation operations. One instance of this class represents an English-version Marble
 * Solitaire game.
 */
public class EnglishSolitaireModel implements MarbleSolitaireModel {
  ...
  /**
   * Instantiates an English-style Marble Solitaire Model with a default arm thickness of 3 and an
   * empty center at (3, 3).
   */
  ...
  /**
   * Instantiates an English-style Marble Solitaire Model with an arm thickness of the passed in
  ...
  /**
   * Instantiates an English-style Marble Solitaire Model with the given arm thickness and a given
   * empty center at (sRow, sCol).
   *
   * @param armThickness the thickness of one side of the plus-shaped board
   * @param sRow         represents the row the center is in
  ...
  /**
   * Returns whether the given sRow and sCol are valid spaces in an English-style Marble Solitaire
  ...
  /**
   * Returns a 2D ArrayList of SlotStates that displays a plus shaped English-style Marble Solitaire
   * Model with the given armThickness and empty starting spot in position (sRow, sCol)
   *
   * @param armThickness the thickness of one side of the plus-shaped board
   * @param sRow         represents the row the center is in
   * @param sCol         represents the column the center is in
  ...
  private ArrayList<ArrayList<SlotState>> makeBoard(int armThickness, int sRow, int sCol) {
    ...
    int r = 0;
    int c = 0;
    while (r < armThickness + ((armThickness - 1) * 2)) {
      ArrayList<SlotState> tempRow = new ArrayList<>();
      while (c < armThickness + ((armThickness - 1) * 2)) {
        if (r == sRow && c == sCol) {
          tempRow.add(SlotState.Empty);
        } else if ((r < armThickness - 1 && c < armThickness - 1) ||
                (r < armThickness - 1 && c >= armThickness * 2 - 1) ||
                (r >= armThickness * 2 - 1 && c < armThickness - 1) ||
